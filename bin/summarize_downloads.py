...
def summarize_downloads(locations, md5sum, design):
    ...
    categories = {
        ...
        '._rmdup.bam' : ('Duplication Removed Alignment BAM file', 'samples'),
        '.CGmap.gz': ('MethylationCalling file', 'samples'),
        'CGmap_matrix.txt' : ('Matrix of Called Methylated Sites file', 'all_samples')
